...
void *errorchecked_malloc(size_t size); // Function prototype for errorchecked_malloc()
...
int main(int argc, char *argv[]) {
    ...
    int_ptr = (int *) errorchecked_malloc(sizeof(int)); // Allocating heap memory for int
...
void *errorchecked_malloc(size_t size) { // An error-checked malloc() function
    void *ptr;
    ptr = malloc(size);
    if (ptr == NULL) {
